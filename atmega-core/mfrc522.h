...
#define pinSlaveSelect_OUTPUT	DDRB |= (1<<PINB4); // change
#define pinSlaveSelect_LOW		PORTB &= ~(1<<PINB4); // change
#define pinSlaveSelect_HIGH		PORTB |= (1<<PINB4); // change

#define pinReset_OUTPUT	DDRA |= (1<<PINA1);
#define pinReset_LOW		PORTA &= ~(1<<PINA1);
#define pinReset_HIGH		PORTA |= (1<<PINA1);
